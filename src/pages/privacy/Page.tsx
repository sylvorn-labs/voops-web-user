          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                At Sylvorn Labs, we believe your financial data belongs
                exclusively to you and your organization. Voops is designed from
                the ground up with strict tenant isolation, end-to-end transport
                encryption, and zero data monetization practices. We never sell
                your personal data or transaction history to advertisers or
                third-party brokers.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                <li>
                  ...
                  Name, email address, password hash, and OAuth identity
                  identifiers (e.g. Google, GitHub) managed securely via
                  Supabase Auth.
                </li>
                <li>
                  <strong className="text-foreground">
                ...
                <li>
                  ...
                  Anonymized performance metrics and error logs used exclusively
                  to diagnose application instability and optimize sync latency.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                Your data is stored within high-security PostgreSQL
                infrastructure with row-level security (RLS) enforcement on all
                database queries:
              </p>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                We partner only with vetted infrastructure providers essential
                for cloud availability and continuous operations:
              </p>
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                <li>
                  <strong className="text-foreground">Supabase / AWS:</strong>{' '}
                  Scalable cloud database hosting, real-time sync websockets,
                  and object storage for receipts.
                </li>
                <li>
                  <strong className="text-foreground">
                    Vercel / Cloudflare:
            ...
            <section>
              ...
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                <li>
                  ...
                  View all profile information and business records at any time
                ...
                <li>
                  ...
                  Export your full transaction data in standard machine-readable
                  CSV / JSON formats.
                </li>
                <li>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                ...
                preferences (Dark / Light mode). We do not load invasive
                third-party cross-site ad trackers.
              </p>
            </section>
