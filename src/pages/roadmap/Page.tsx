          ...
          <div className="space-y-10">
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                Voops is built to eliminate the chaos of managing finances
                across multiple businesses, ventures, and teams. Our roadmap is
                driven directly by community feedback, open-source contributors,
                and the daily workflow demands of founders and operators.
              </p>
            </section>
            ...
            <section className="border-border/60 bg-card rounded-2xl border p-6 shadow-xs">
              ...
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                <li>
                  ...
                  Single user authentication with instantaneous switching
                  between independent business workspaces.
                </li>
                <li>
                  <strong className="text-foreground">
                ...
                <li>
                  ...
                  Granular permissions for workspace owners, admins, members,
                  and viewers.
                </li>
              </ul>
            </section>
            ...
            <section className="border-border/60 bg-card rounded-2xl border p-6 shadow-xs">
              ...
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                ...
                <li>
                  ...
                  Visual graphs forecasting monthly burn rate and runway across
                  all businesses.
                </li>
                <li>
                  <strong className="text-foreground">
                  ...
                  One-click migration from QuickBooks, Wave, and bank
                  statements.
                </li>
              </ul>
            </section>
            ...
            <section className="border-border/60 bg-card rounded-2xl border p-6 shadow-xs">
              ...
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                <li>
                  ...
                  Fast offline-first mobile apps for real-time receipt scanning
                  on the go.
                </li>
                <li>
                  <strong className="text-foreground">
                  ...
                  Programmatically sync transactions from custom payment
                  gateways and internal ERPs.
                </li>
                <li>
                  <strong className="text-foreground">
                    Audit-Ready Tax Packs:
                  </strong>{' '}
                  Generate consolidated PDF / Excel year-end packages tailored
                  for accountants.
                </li>
                <li>
                  <strong className="text-foreground">
