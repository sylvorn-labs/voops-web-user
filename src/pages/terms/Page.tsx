          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                ...
                tools. You may create or join multiple business workspaces under
                a single user authentication identity.
              </p>
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                <li>
                  ...
                  The individual or entity that registers a workspace is the
                  primary administrator and responsible for all transactions
                  recorded within that workspace.
                </li>
                <li>
                  <strong className="text-foreground">Team Permissions:</strong>{' '}
                  Workspace administrators may assign roles (e.g. Owner, Admin,
                  Member, Viewer). Administrators are responsible for
                  maintaining accurate permission sets.
                </li>
                <li>
                  <strong className="text-foreground">
                    Accuracy of Financial Data:
                  </strong>{' '}
                  You acknowledge that you are solely responsible for verifying
                  the accuracy of transaction entries, receipts, category
                  allocations, and tax calculations.
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                To protect your business data and account integrity, you agree
                to:
              </p>
              <ul className="text-muted-foreground mt-3 list-disc space-y-2 pl-6">
                <li>
                  Maintain the confidentiality of your authentication
                ...
                <li>
                  Refrain from attempting to reverse-engineer, exploit, or
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                ...
                services, hosted synchronization endpoints, automated backups,
                and proprietary analytical features are subject to our hosted
                service tier guidelines and fair usage policies.
              </p>
            </section>
            ...
            <section>
              ...
              <blockquote className="border-border/60 bg-muted/30 border-l-primary my-4 rounded-r-lg border-l-4 p-4 text-sm italic">
                Voops is an expense tracking and financial analysis utility.
                Voops and Sylvorn Labs do not provide certified financial,
                accounting, legal, or tax advice. Always consult a qualified
                professional for regulatory compliance and audit filings.
              </blockquote>
              <p className="text-muted-foreground mt-2 leading-relaxed">
                To the maximum extent permitted by applicable law, Sylvorn Labs
                shall not be liable for any indirect, incidental, special,
                consequential, or punitive damages resulting from loss of
                profits, data corruption, or business disruption.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                ...
                records and receipts in open formats (JSON/CSV). Upon
                termination, your active access will cease in accordance with
            ...
            <section>
              ...
              <p className="text-muted-foreground mt-2 leading-relaxed">
                ...
                discretion. Notice of material changes will be provided via
                platform notifications or by updating the revision date at the
